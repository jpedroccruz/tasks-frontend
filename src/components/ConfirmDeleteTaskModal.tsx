      ...
      <div className="max-w-[566px]">
        <BlueContainer as={'div'}>
          <div className="flex justify-between w-full">
            <span className="text-[20px] font-semibold">Excluir tarefa</span>
          ...
          <div className="flex flex-col bg-white p-6 w-full rounded-3xl gap-6">
            <p className="text-2xl text-[#000017]">Confirmar exclusão da tarefa: Estudar TypeScript</p>
            <div className="flex justify-between gap-2">
              ...
              <ConfirmButton color="red" onClick={closeConfirmDeleteTaskModal} >Não</ConfirmButton>
            </div>
          </div>
        </BlueContainer>
      </div>
